  ...
  return (
    <>
      <div class="small-container single-product">
        <div class="row">
          <div class="col-2">
            <img src="products-15.jpg" width="100%" id="ProductImg" />

            <div class="small-img-row">
              <div class="small-img-col">
                <img src="products-15.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-15.1.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-15.2.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-15.3.jpg" width="100%" class="small-img" />
              </div>
            </div>
          </div>
          <div class="col-2">
