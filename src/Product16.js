...
export default function Product16() {
  useEffect(() => {
  ...
  return (
    <>
      <div class="small-container single-product">
        <div class="row">
          <div class="col-2">
            <img src="products-16.jpg" width="100%" id="ProductImg" />

            <div class="small-img-row">
              <div class="small-img-col">
                <img src="products-16.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-16.1.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-16.2.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-16.3.jpg" width="100%" class="small-img" />
              </div>
            </div>
          </div>
          <div class="col-2">
