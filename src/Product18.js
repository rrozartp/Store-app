...
export default function Product18() {
  useEffect(() => {
  ...
  return (
    <>
      <div class="small-container single-product">
        <div class="row">
          <div class="col-2">
            <img src="products-18.jpg" width="100%" id="ProductImg" />

            <div class="small-img-row">
              <div class="small-img-col">
                <img src="products-18.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-18.1.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-18.2.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-18.3.jpg" width="100%" class="small-img" />
              </div>
            </div>
          </div>
          <div class="col-2">
            <p>Home / Watch</p>
            <h1>Rolex Quality-AAA</h1>
            <h4>$25,000.00</h4>
            <select>
