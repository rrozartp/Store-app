  ...
  return (
    <>
      <div class="small-container single-product">
        <div class="row">
          <div class="col-2">
            <img src="products-13.jpg" width="100%" id="ProductImg" />

            <div class="small-img-row">
              <div class="small-img-col">
                <img src="products-13.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-13.1.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-13.2.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-13.3.jpg" width="100%" class="small-img" />
              </div>
            </div>
          </div>
          <div class="col-2">
            <p>Home / Shoes</p>
            <h1>Adidas Runfalcon</h1>
            <h4>$99.00</h4>
            <select>
