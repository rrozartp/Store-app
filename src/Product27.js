  ...
  return (
    <>
      <div class="small-container single-product">
        <div class="row">
          <div class="col-2">
            <img src="products-27.jpg" width="100%" id="ProductImg" />

            <div class="small-img-row">
              <div class="small-img-col">
                <img src="products-27.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-27.1.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-27.2.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-27.3.jpg" width="100%" class="small-img" />
              </div>
            </div>
          </div>
          <div class="col-2">
            <p>Home / Bag</p>
            <h1>Karl Lagerfeld Bag</h1>
            <h4>$380.00</h4>
            <select>
