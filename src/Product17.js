...
export default function Product17() {
  useEffect(() => {
  ...
  return (
    <>
      <div class="small-container single-product">
        <div class="row">
          <div class="col-2">
            <img src="products-17.jpg" width="100%" id="ProductImg" />

            <div class="small-img-row">
              <div class="small-img-col">
                <img src="products-17.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-17.1.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-17.2.jpg" width="100%" class="small-img" />
              </div>
              <div class="small-img-col">
                <img src="products-17.3.jpg" width="100%" class="small-img" />
              </div>
            </div>
          </div>
          <div class="col-2">
            <p>Home / Accesories</p>
            <h1>Gold 14K Jewerly</h1>
            <h4>$250.00</h4>
            <select>
